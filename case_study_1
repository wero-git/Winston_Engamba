# Introduction
>Throughout what follows, the process described is that of a customer return followed by a claim. 
>Failures will be identified, modeled, and a proposed solution will be resolved.
---
# Process description
